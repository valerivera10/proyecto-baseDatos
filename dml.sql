...
INSERT INTO oficina (codigo_oficina, ciudad, pais, region, codigo_postal, telefono, linea_direccion1, linea_direccion2) VALUES
    ...
    ('OF006', 'Madrid', 'España', 'Comunidad de Madrid', '28001', '111-2222', 'Calle Ejemplo 456', 'Edificio X, Piso 2');
...
INSERT INTO empleado (nombre, apellido1, apellido2, extension, email, codigo_oficina, codigo_jefe, puesto) VALUES
    ...
    ('Carlos', 'Gonzalez', 'Perez', '106', 'carlos.gonzalez@example.com', 'OF001', NULL, 'Vendedor');
...
INSERT INTO cliente (nombre_cliente, nombre_contacto, apellido_contacto, telefono, fax, linea_direccion1, linea_direccion2, ciudad, region, pais, codigo_postal, codigo_empleado_rep_ventas, limite_credito) VALUES
    ...
    ('Consultor', 'Manuel', 'Martinez', '678901234', '432109876', 'Calle Ejemplo 123', 'Apt 101', 'Madrid', 'Madrid', 'España', '28001', 1, 5000.00);
...
INSERT INTO producto (codigo_producto, nombre, gama, dimensiones, proveedor, descripcion, cantidad_en_stock, precio_venta, precio_proveedor) VALUES
    ('P001', 'Producto 1', 'Gama Baja', '10x10x10', 'Proveedor A', 'Descripcion del Producto 1', 200, 50.00, 30.000),
    ('P002', 'Producto 2', 'Gama Media', '20x20x20', 'Proveedor B', 'Descripcion del Producto 2', 200, 100.00, 60.000),
    ('P003', 'Producto 3', 'Gama Alta', '30x30x30', 'Proveedor C', 'Descripcion del Producto 3', 300, 150.00, 90.000),
    ('P004', 'Producto 4', 'Gama Baja', '40x40x40', 'Proveedor D', 'Descripcion del Producto 4', 400, 200.00, 50.000),
    ('P005', 'Producto 5', 'Gama Lujo', '50x50x50', 'Proveedor E', 'Descripcion del Producto 5', 500, 250.00, 40.000);
...
INSERT INTO pedido (fecha_pedido, fecha_espera, fecha_entrega, estado, comentarios, codigo_cliente) VALUES
    ...
    ('2008-05-15', '2008-05-20', '2008-05-25', 'Completado', 'Entregar por la tarde', 1);
...
INSERT INTO pago (codigo_cliente, forma_pago, id_transaccion, fecha_pago, total) VALUES
    ...
    (1, 'Tarjeta de crédito', 'TXN006', '2008-05-25', 300.00);
